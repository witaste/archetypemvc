...
var uploadFn = function(options) {
  ...
  //开始上传图片
	var opt = {
			url : "/hehejiankang/upload1.html",
			dataType : "json",
			type : "post",
			cache: false,
			success : function(data){
				
				options.onFileUploadComplete(data);
...
var downloadFn = function(options){
    ...
    if(options.thumb){
        options.thumb  = options.thumb.replace("/undefined","");
    }
...
connection.prototype.sendPicture = function(options) {
    ...
    var myUploadComplete = function(data) {
        ...
        options["file_length"] = data.file_length;
        options["filetype"] = data.filetype;
